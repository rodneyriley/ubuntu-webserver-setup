...
do  
mkdir /var/www/web
mkdir /var/www/web/.well-known
touch /var/www/web/.htaccess
...
letsencrypt certonly -a webroot --webroot-path=/var/www/web -d ${DOMAIN[i]} 
...
letsencrypt certonly -a webroot --webroot-path=/var/www/web -d ${WWW_DOMAIN[i]}
fi
done
